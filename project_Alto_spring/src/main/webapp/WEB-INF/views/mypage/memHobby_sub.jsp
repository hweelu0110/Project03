...
<head>
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#hobby_list .sub_hobby.select").children("input").attr("name","sub_code")
			
			$("#hobby_list .sub_hobby").click(function() {
...
<body>
	...
	<section>
		<div id="member_div" class="member_info">
			<h2>내 취미 설정</h2>
			<form name="hobbyFrm" method="post" action="${path}/mypage/memHobbyUpdate.do" onsubmit="return sendHobbyList()">
