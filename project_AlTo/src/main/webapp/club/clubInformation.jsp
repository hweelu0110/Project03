...
<head>
	...
	<link rel="stylesheet" href="../css/clubInformation.css" /> 
</head>
<body>
		...
		<div>
			<div class="left">
				<div class="clubcontent2">
					<img src="../img/clubinformation_test.png">
					<span class="like_icon">관심</span>
				</div>
				
				<div class="clubcontent3">
					<span class="hobby_icon"><img src="../img/hobby_img/h_002.png" /></span>
					<h3>모임제목</h3>	
					<img class="edit" src="../img/edit.png"><br /><br/>
				...
				<section class="section">
					...
					<div class="clubcontent6">
						...
						<img class="gps" src="../img/gps.png">스쿠버 다이빙
				...
				<div class="member">
					<ul>
						<li><img src="../img/user_test.png" /></li>
						<li><img src="../img/user_test.png" /></li>
						<li><img src="../img/user_test.png" /></li>
						<li><img src="../img/user_test.png" /></li>
						<li><img class="plus" src="../img/plus.png"/></li>
					</ul>
				</div>
